...
FINANCE_TOOLS = [
    {
        ...
        "inputs": [
            {"id": "gross_income", "label": "Gross monthly income", "value": 6000, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "housing", "label": "Monthly housing payment", "value": 1500, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "other_debt", "label": "Other monthly debt payments", "value": 500, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "target_dti", "label": "Target total DTI", "value": 36, "min": 0, "max": 100, "step": 0.1, "kind": "percent"},
        ],
        "results": [
            {"key": "back_end", "label": "Total debt-to-income ratio", "format": "percent"},
            {"key": "front_end", "label": "Housing-only ratio", "format": "percent"},
            {"key": "total_debt", "label": "Current monthly debt", "format": "currency"},
            {"key": "remaining_capacity", "label": "Remaining debt capacity", "format": "currency"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            {"id": "property_value", "label": "Current property value", "value": 300000, "min": 0.01, "step": 0.01, "kind": "money"},
            {"id": "primary_loan", "label": "Primary loan balance", "value": 210000, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "secondary_loan", "label": "Second loan or secured balance", "value": 0, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "target_ltv", "label": "Target combined LTV", "value": 80, "min": 0, "max": 100, "step": 0.1, "kind": "percent"},
        ],
        "results": [
            {"key": "ltv", "label": "Combined loan-to-value", "format": "percent"},
            {"key": "equity", "label": "Estimated property equity", "format": "currency"},
            {"key": "total_loan", "label": "Total secured balance", "format": "currency"},
            {"key": "additional_capacity", "label": "Additional room at target LTV", "format": "currency"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            {"id": "gross_income", "label": "Gross monthly income", "value": 8000, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "monthly_debt", "label": "Existing monthly debt payments", "value": 750, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "annual_rate", "label": "Annual mortgage rate", "value": 7, "min": 0, "step": 0.01, "kind": "percent"},
            {"id": "years", "label": "Mortgage term", "value": 30, "min": 1, "max": 50, "step": 1, "kind": "years"},
            {"id": "down_payment", "label": "Available down payment", "value": 50000, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "monthly_tax_insurance", "label": "Monthly taxes, insurance and fees", "value": 550, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "target_dti", "label": "Target total DTI", "value": 36, "min": 0, "max": 100, "step": 0.1, "kind": "percent"},
        ],
        "results": [
            {"key": "home_price", "label": "Estimated affordable home price", "format": "currency"},
            {"key": "loan_amount", "label": "Estimated mortgage amount", "format": "currency"},
            {"key": "housing_budget", "label": "Maximum monthly housing budget", "format": "currency"},
            {"key": "principal_interest", "label": "Available principal and interest", "format": "currency"},
        ],
    ...
    },
    {
        ...
        "inputs": [
            {"id": "balance", "label": "Current debt balance", "value": 15000, "min": 0, "step": 0.01, "kind": "money"},
            {"id": "annual_rate", "label": "Annual interest rate", "value": 18, "min": 0, "step": 0.01, "kind": "percent"},
            {"id": "monthly_payment", "label": "Scheduled monthly payment", "value": 450, "min": 0.01, "step": 0.01, "kind": "money"},
            {"id": "extra_payment", "label": "Extra monthly payment", "value": 100, "min": 0, "step": 0.01, "kind": "money"},
        ],
        "results": [
            ...
            {"key": "months_saved", "label": "Months saved with extra payment", "format": "months"},
        ],
